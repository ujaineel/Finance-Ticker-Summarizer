(To use this extension locally, since it's not published)
To load this extension in development mode, do this:
...
To use this extension, do this:
1. Open the side panel by clicking the extension icon in the toolbar
2. Type the ticker symbol or company name in the search bar
3. Click the search button
4. The extension will display the stock data in the side panel
